            ...
            <div class="bg-white rounded-xl shadow-sm p-8">
                <div class="max-w-7xl mx-auto">
                    ...
                    <nav class="mb-6" aria-label="Breadcrumb">
                        <ol class="flex items-center space-x-2 text-sm">
                            ...
                            <li class="flex items-center">
                                ...
                                <span class="ml-2 text-green-800">Create Event</span>
                            </li>
                        </ol>
                    </nav>
                    ...
                    <div class="flex flex-col space-y-8 mb-6">
                        <div>
                            <h1 class="text-4xl font-bold text-green-800 tracking-tight">Create New Event</h1>
                            <p class="mt-2 text-base text-green-600">Add a new event to your garden calendar</p>
                        </div>
                    </div>

                    <!-- Event Creation Form -->
                    <form action="{{ route('events.store') }}" method="POST" enctype="multipart/form-data"
                        x-data="{ previewUrl: null }" class="space-y-6">
                        @csrf
